struct KClapSwitch {
  ...
  bool isLight1Toggle() {
    if (index == 4) {
      if (claps[1]-claps[0] < 1000 && claps[2]-claps[1] < 1000 && claps[3]-claps[2] > 1000) {
        index = 0;
        return true;
      }
    }
  ...
  bool isLight2Toggle() {
    if (index == 5) {
      if (claps[1]-claps[0] < 1000 && claps[2]-claps[1] < 1000 && claps[3]-claps[2] > 1000 && claps[4]-claps[3] < 1000) {
        index = 0;
        return true;
      }
    }
